  ...
  renderLoggedInContent() {
    return (
      <div>
        ...
        <div>
          <div><a href={`http://sso-client.dev:9000/user/profile?clientId=${config.clientId}&accessToken=${localstorage('accessToken')}&redirect_uri=${config.redirectUri}`}>Edit Profile</a></div>
